...
class FusionBlock_new3_new_method(nn.Module):
    def __init__(self, args, ref_channels, last_flag=True):
        ...
        self.channels = args.channels   # 假设 channels 是基础通道数
...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size):
        ...
        self.conv_1 = nn.Conv2d(self.in_channels, self.out_channels, 3, 1, 1, groups=self.in_channels)
        self.conv_2 = nn.Conv2d(self.out_channels, self.out_channels, 3, 1, 1, groups=self.in_channels)
