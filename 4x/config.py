...
parser.add_argument("--scale_factor", type=int, default=4, help="4, 8")
...
parser.add_argument("--path_pre_pth", type=str, default='./pretrain/LF-RWKVNet_5x5_4x_model.pth',
...
parser.add_argument('--patch_size_for_test', default=24, type=int, help='patch size')
parser.add_argument('--stride_for_test', default=12, type=int, help='stride')
parser.add_argument('--batch_size', type=int, default=1)
parser.add_argument('--lr', type=float, default=2e-4, help='initial learning rate')
parser.add_argument('--decay_rate', type=float, default=0, help='weight decay [default: 2e-4]')
...
# parameters for test
args.patch_size_for_test = 24
args.stride_for_test = 12
