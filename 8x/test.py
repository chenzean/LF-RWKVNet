...
def main(args):
    ...
    with torch.no_grad():
        ...
        psnr_iter_test, ssim_iter_test, LF_name, psnr_iter_test_allviews,ssim_iter_test_allviews, single_sence_time_avg = test(Test_Loaders, device, net, LF_epoch_save_dir,
